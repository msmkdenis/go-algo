...
// https://contest.yandex.ru/contest/22781/run-report/102702736/
...
-- ВРЕМЕННАЯ СЛОЖНОСТЬ --
Все операции интерфейса Deque выполняется с константной сложностью О(1)

-- ПРОСТРАНСТВЕННАЯ СЛОЖНОСТЬ --
Для хранения элементов потребуется O(n) памяти (в размере слайса).
*/
