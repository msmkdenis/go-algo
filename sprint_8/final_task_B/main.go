...
-- ВРЕМЕННАЯ СЛОЖНОСТЬ --
  Построение Trie:
  Вставка каждого слова в Trie занимает O(l) времени, где l - максимальная длина слова.
  Если у нас m слов, и l - максимальная длина, то общее время на построение Trie составляет O(m * l).
